...
const features = [
  {
    ...
    description:
      "Notre équipe de rédacteurs professionnels connaît les attentes des recruteurs dans votre secteur.",
  },
  {
    icon: Target,
        ...
        <AnimatedSection direction="left">
          <div className="max-w-2xl mx-auto mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2D1155] mb-3 md:mb-4 text-center">
              Pourquoi choisir L&apos;Expert pour rédiger votre CV ou votre
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-[#2D1155] mb-2 md:mb-3">
                    {feature.title}
                  </h3>
